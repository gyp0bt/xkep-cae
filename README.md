...
**~2260テスト + 266 新パッケージテスト** — 2026-03-16時点 | [ロードマップ](docs/roadmap.md) | [ステータス一覧](docs/status/status-index.md)
...
| **脱出ポット計画** | **新 xkep_cae を Process Architecture でゼロ構築** | **Phase 3 完了 — concrete プロセス移行** |
