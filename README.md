...
| **大規模収束** | **37本NCP収束達成（径方向圧縮Layer1）、UL CR梁で7本90°曲げ+揺動収束達成、NCP 6x+要素12.6xバッチ化高速化、ソルバー一本化完了（n_load_steps廃止、NCPSolverInput）** | **91本曲げ揺動で収束** |
...
| [ステータス一覧](docs/status/status-index.md) | 全133件のstatus + テスト数推移 |
