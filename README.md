...
HEX8 要素ファミリ: C3D8（SRI）、C3D8R（低減積分+アワーグラス制御）、C3D8I（非適合モード）。3D等方弾性テンソル。Abaqus準拠命名。
...
- [実装状況](docs/status/status-061.md) — 最新のステータス（HEX8 要素ファミリ拡充 — C3D8/C3D8R/C3D8I + Abaqus命名準拠）
