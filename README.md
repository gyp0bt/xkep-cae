...
**200+10s+16+3+23+1+6+18+2+4+3+9+4+18+2 テスト** — 2026-03-30時点 | frozen=False 35%高速化 + Hermite非局所∂g/∂u Step1（status-271） | 契約違反 **0件** | 条例違反 **0件** | [ロードマップ](docs/roadmap.md) | [ステータス一覧](docs/status/status-index.md)
