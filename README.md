...
**~2260テスト + 284 新パッケージテスト** — 2026-03-16時点 | [ロードマップ](docs/roadmap.md) | [ステータス一覧](docs/status/status-index.md)
...
| **脱出ポット計画** | **新 xkep_cae を Process Architecture でゼロ構築** | **Phase 7 進行中 — C14 違反 4→2件（mesh/output 除去済）** |
