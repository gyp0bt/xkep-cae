...
| **大規模収束** | **19本NCP曲げ揺動収束達成（90°+揺動1周期）、37本径方向圧縮Layer1収束、NCP 6x+要素12.6xバッチ化高速化、ソルバー一本化完了、被膜接線剛性実装（k=1e6収束）** | **91本曲げ揺動で収束** |
...
| [ステータス一覧](docs/status/status-index.md) | 全143件のstatus + テスト数推移 |
