...
**2263テスト（fast: 1689 / slow: 356 / deprecated: 218）** — 2026-03-06時点
...
| **大規模収束** | **37本NCP収束達成（径方向圧縮Layer1）、61/91本テスト追加** | **61本以上で収束** |
| **チューニング基盤** | TuningTaskスキーマ + 検証プロット14種 + YAML/JSON直列化 + Optuna連携 | AI自動チューニング |
| **可視化** | 四元数2D投影・接触診断パネル・変形比較・層別レンダリング | 数値困難の診断 |
...
| [ステータス一覧](docs/status/status-index.md) | 全124件のstatus + テスト数推移 |
