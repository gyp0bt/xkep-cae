...
HEX8 B-bar 要素: 8節点6面体レンガ要素（B-bar法体積ロッキング回避）。3D等方弾性テンソル。
...
- [実装状況](docs/status/status-059.md) — 最新のステータス（HEX8 B-bar 要素 + シース曲げモードバリデーション）
