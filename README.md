...
**Phase 1〜3 + Phase 4.1〜4.2 + Phase 5.1〜5.4 + Phase C0〜C2 + 過渡応答出力 + FIELD ANIMATION出力 + GIFアニメーション出力 + CR梁定式化 + CR梁ファイバー弾塑性完了。905テスト。**
...
- [実装状況](docs/status/status-043.md) — 最新のステータス（Abaqus弾塑性三点曲げバリデーション）
