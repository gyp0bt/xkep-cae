...
**~2260テスト + 374 新パッケージテスト** — 2026-03-17時点 | C14/C16 違反 **0件** | [ロードマップ](docs/roadmap.md) | [ステータス一覧](docs/status/status-index.md)
...
| **脱出ポット計画** | **新 xkep_cae を Process Architecture でゼロ構築** | **Process 実行診断インフラ + Phase 14 完了** |
