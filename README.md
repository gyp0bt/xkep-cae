...
| **大規模収束** | **19本曲げ揺動収束、37本径方向圧縮収束** | **凍結中（R1 Phase 7 完了まで）** |
| **Process Architecture** | **Phase 1-6 完了、Phase 7 進行中** | **BatchProcess + VerifyProcess + C3-C12** |
...
| [ステータス一覧](docs/status/status-index.md) | 全161件のstatus + テスト数推移 |
