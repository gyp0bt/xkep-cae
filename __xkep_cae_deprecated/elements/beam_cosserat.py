...
from __xkep_cae_deprecated.math.quaternion import (
    quat_from_rotvec,
    quat_identity,
...
if TYPE_CHECKING:
    ...
    from __xkep_cae_deprecated.core.results import (
        AssemblyResult,
        FiberAssemblyResult,
...
def assemble_cosserat_beam(
    ...
    *,
    ...
    from __xkep_cae_deprecated.core.results import AssemblyResult
...
def assemble_cosserat_beam_plastic(
    ...
    *,
    ...
    from __xkep_cae_deprecated.core.results import PlasticAssemblyResult
...
def _compute_generalized_stress_fiber(
    ...
    from __xkep_cae_deprecated.core.state import CosseratFiberPlasticState as _CFPS
...
def assemble_cosserat_beam_fiber(
    ...
    *,
    ...
    from __xkep_cae_deprecated.core.results import FiberAssemblyResult
