...
def _rotvec_to_rotmat(theta: np.ndarray) -> np.ndarray:
    ...
    Returns:
        R: (3, 3) 回転行列
    """
    from __xkep_cae_deprecated.math.quaternion import quat_from_rotvec, quat_to_rotation_matrix
...
def _rotmat_to_rotvec(R: np.ndarray) -> np.ndarray:
    ...
    Returns:
        theta: (3,) 回転ベクトル
    """
    from __xkep_cae_deprecated.math.quaternion import quat_to_rotvec, rotation_matrix_to_quat
