...
from __xkep_cae_deprecated.process.categories import PostProcess
from __xkep_cae_deprecated.process.data import MeshData, SolverResultData
...
class BeamRenderProcess(PostProcess[RenderConfig, RenderResult]):
    ...
    def process(self, input_data: RenderConfig) -> RenderResult:
        ...
        try:
            from __xkep_cae_deprecated.visualization.render_3d import render_beam_tubes
