...
from __xkep_cae_deprecated.process.categories import CompatibilityProcess, SolverProcess
...
from __xkep_cae_deprecated.process.strategies.protocols import PenaltyStrategy
