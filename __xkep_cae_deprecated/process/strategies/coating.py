...
class KelvinVoigtCoatingProcess(SolverProcess[None, None]):
    ...
    def friction_forces(
        ...
        """
        from __xkep_cae_deprecated.contact.law_friction import return_mapping_core
    ...
    def friction_stiffness(
        ...
        """
        from __xkep_cae_deprecated.contact.law_friction import tangent_2x2_core
