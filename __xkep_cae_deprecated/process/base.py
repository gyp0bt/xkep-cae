...
from __xkep_cae_deprecated.process.registry import ProcessRegistry, RegistryProxy
...
class AbstractProcess(ABC, Generic[TIn, TOut], metaclass=ProcessMetaclass):
    ...
    def effective_uses(self) -> list[type[AbstractProcess]]:
        ...
        """
        from __xkep_cae_deprecated.process.slots import collect_strategy_types
