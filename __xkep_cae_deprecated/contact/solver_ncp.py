...
if TYPE_CHECKING:
    from __xkep_cae_deprecated.process.strategies.protocols import LinearSolverStrategy

import numpy as np
import scipy.sparse as sp

from __xkep_cae_deprecated.contact.assembly import (
    _contact_dofs,
...
from __xkep_cae_deprecated.contact.graph import ContactGraphHistory, snapshot_contact_graph
from __xkep_cae_deprecated.contact.initial_penetration import (
    adjust_initial_positions,
    check_initial_penetration,
)
from __xkep_cae_deprecated.contact.law_friction import compute_mu_effective
...
from __xkep_cae_deprecated.contact.pair import ContactManager, ContactStatus
from __xkep_cae_deprecated.contact.staged_activation import (
...
def _solve_linear_system(
    ...
    *,
    ...
    """
    from __xkep_cae_deprecated.process.strategies.linear_solver import create_linear_solver
...
def _apply_bc_csr(K, rhs, fixed_dofs):
    ...
    from __xkep_cae_deprecated.contact.bc_utils import apply_bc_fast
...
def newton_raphson_contact_ncp(
    ...
    *,
    ...
    if _time_strategy is None:
        from __xkep_cae_deprecated.process.strategies.time_integration import (
    ...
    if _penalty_strategy_pre is not None:
        ...
        from __xkep_cae_deprecated.process.strategies.penalty import create_penalty_strategy
    ...
    if _friction_strategy_pre is not None:
        ...
        from __xkep_cae_deprecated.process.strategies.friction import create_friction_strategy
    ...
    if _contact_force_strategy_pre is not None:
        ...
        from __xkep_cae_deprecated.process.strategies.contact_force import (
    ...
    if _use_coating and _coating_strategy is None:
        from __xkep_cae_deprecated.process.strategies.coating import create_coating_strategy
