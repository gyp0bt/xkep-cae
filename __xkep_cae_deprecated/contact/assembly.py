...
from __xkep_cae_deprecated.contact.pair import ContactManager, ContactPair, ContactStatus
...
def _consistent_st_stiffness_at_gp(
    ...
    # g_n at Gauss point
    from __xkep_cae_deprecated.contact.line_contact import _build_shape_vector_at_gp
