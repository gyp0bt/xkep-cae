...
def build_sheath_contact_manager(
    ...
    *,
    ...
    """
    from __xkep_cae_deprecated.mesh.twisted_wire import (
...
def rebuild_compliance_matrix(
    ...
    *,
    ...
    """
    from __xkep_cae_deprecated.mesh.ring_compliance import build_variable_thickness_compliance_matrix
...
def sheath_outer_radius(
    ...
    *,
    ...
    Returns:
        シース外径 [m]
    """
    from __xkep_cae_deprecated.mesh.twisted_wire import sheath_inner_radius
