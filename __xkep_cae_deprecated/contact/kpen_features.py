...
from __xkep_cae_deprecated.contact.broadphase import broadphase_aabb
from __xkep_cae_deprecated.contact.geometry import closest_point_segments
from __xkep_cae_deprecated.contact.prescreening_data import extract_segments
