...
from __xkep_cae_deprecated.tuning.schema import TuningResult, TuningRun
...
def execute_s3_benchmark(
    ...
    **solver_params: Any,
    ...
    Returns:
        TuningRun: ベンチマーク結果
    """
    from __xkep_cae_deprecated.numerical_tests.wire_bending_benchmark import (
...
def run_scaling_analysis(
    ...
    **solver_params: Any,
    ...
    """
    from __xkep_cae_deprecated.tuning.presets import s3_scaling_task
