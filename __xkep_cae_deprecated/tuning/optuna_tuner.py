...
使用例::
    ...
    from __xkep_cae_deprecated.tuning.optuna_tuner import run_optuna_study
    from __xkep_cae_deprecated.tuning.presets import s3_convergence_task
...
from __xkep_cae_deprecated.tuning.schema import TuningResult, TuningTask
...
def create_objective(
    ...
    **base_params: Any,
    ...
    Returns:
        Optuna objective 関数
    """
    from __xkep_cae_deprecated.tuning.executor import execute_s3_benchmark
