...
def export_bending_oscillation_gif(
    ...
    *,
    ...
    try:
        ...
        from __xkep_cae_deprecated.output.render_beam_3d import VIEW_PRESETS, render_twisted_wire_3d
    except ImportError:
        return []
...
def run_bending_oscillation(
    ...
    *,
    ...
    if coating_thickness > 0.0:
        from __xkep_cae_deprecated.mesh.twisted_wire import CoatingModel, coated_radii
