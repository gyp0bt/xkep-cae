...
from __xkep_cae_deprecated.numerical_tests.core import (
    NumericalTestConfig,
    StaticTestResult,
...
def _get_ke_func(cfg: NumericalTestConfig, sec: dict):
    ...
    if cfg.beam_type == "eb2d":
        ...
        from __xkep_cae_deprecated.elements.beam_timo3d import timo_beam3d_ke_global
        ...
        from __xkep_cae_deprecated.elements.beam_cosserat import cosserat_ke_global
...
def _compute_section_forces(
    ...
    if cfg.beam_type == "eb2d":
        ...
        from __xkep_cae_deprecated.elements.beam_cosserat import cosserat_section_forces
