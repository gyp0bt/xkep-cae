...
| [221](status-221.md) | 2026-03-21 | 接触力符号規約の統一 — エネルギー勾配規約への移行 | 499(新) |
| [222](status-222.md) | 2026-03-21 | Huber型C¹ペナルティ導入 — NR 2次収束達成 | 185(新) |
| [222](status-222.md) | 2026-03-21 | Uzawa有効化試行 + softplus非互換性確認 + 収束診断基盤 | 495(新) |
| [223](status-223.md) | 2026-03-21 | ペナルティパラメータ完全自動化 + 手動調整禁止（C18）| 188(新) |
| [224](status-224.md) | 2026-03-21 | 手動ペナルティパラメータの物理削除 | 553(新) |
...
押し下げ変換:    499(新) (2026-03-20) ← status-220（押し下げ変位制御化+準静的自動検知+符号問題特定）
符号規約統一:    499(新) (2026-03-21) ← status-221（エネルギー勾配規約統一）
Huber型NR2次:   185(新) (2026-03-21) ← status-222（Huber型C¹ペナルティ+NR 2次収束）
```
