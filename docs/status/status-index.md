...
| [313](status-313.md) | 2026-04-10 | プロファイル統計API強化 + BenchmarkRunnerプロファイル自動キャプチャ | 459+13 passed |
...
プロファイルAPI:         200+10s+16+3+23+1+6+18+2+4+3+9+4+18+2+2+2+15+4+13+14+6+9+3+5+13(新) (2026-04-10) ← status-313（ProcessMetaclassプロファイル統計API強化+BenchmarkRunnerプロファイル自動キャプチャ）
```
