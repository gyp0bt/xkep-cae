...
| [311](status-311.md) | 2026-04-08 | adj batchバッチ化 + BC適用20000x高速化 + pypardiso統合 | 445+20+14+6+3+6 passed |
| [312](status-312.md) | 2026-04-09 | LinearSolveProcess最適化 — BCベクトル化+ソルバーキャッシュ+MPC triple productキャッシュ+責務分離修正 | 515 passed |
...
LinearSolve最適化:      200+10s+16+3+23+1+6+18+2+4+3+9+4+18+2+2+2+15+4+13+14+6+9+3 (2026-04-09) ← status-312（BCベクトル化+ソルバーキャッシュ+MPCキャッシュ+責務分離修正）
```
