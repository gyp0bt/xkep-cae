...
| [317](status-317.md) | 2026-04-10 | dominant_leaf_process 拡張（wrapper/leaf 自動分類）+ Process Metaclass 拡張 | 459+13+11+7 passed |
...
leaf分類拡張:           200+10s+16+3+23+1+6+18+2+4+3+9+4+18+2+2+2+15+4+13+14+6+9+3+5+13+11+7(新) (2026-04-10) ← status-317（ProcessMetaclass wrapper追跡+dominant_leaf_process拡張）
```
