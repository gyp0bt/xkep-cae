...
| [313](status-313.md) | 2026-04-09 | 被膜なし7本撚線 曲げ揺動ベースライン — 1527s→967s(37%高速化) | 459 passed |
| [314](status-314.md) | 2026-04-09 | surface_pair_n_neighbor パイプライン貫通 — 7本では効果なし、デフォルト=0維持 | 459 passed |
...
ベースライン計測:       459(新) (2026-04-09) ← status-313（被膜なし7本曲げ揺動: 1527s→967s、37%高速化）
n_neighbor貫通:         459(新) (2026-04-09) ← status-314（surface_pair_n_neighborパイプライン貫通、7本効果なし）
```
