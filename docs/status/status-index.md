...
| [229](status-229.md) | 2026-03-23 | s_unclamped伝搬 + freeze_normal + Hermite不整合特定 | 133+10s(新) |
...
C1連続化:        186+10s(新) (2026-03-23) ← status-228（smooth_clamp frac=0.96到達+Hermite暫定デフォルト化）
壁突破基盤:      133+10s(新) (2026-03-23) ← status-229（s_unclamped伝搬+freeze_normal+Hermite不整合特定）
```
