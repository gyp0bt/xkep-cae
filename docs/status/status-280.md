...
| 7本 + free_end + 接触なし(θ_z=ねじり) | 0.377 | 34°(ねじり) | 416 | 12反復→2サイクル検知（||R_t||=3e-2） |
| 7本 + free_end + 接触なし(θ_y=曲げ) | 0.163 | **15°(曲げ)** | 46 | 200反復不収束（ヘリカル角問題） |
| 7本 + free_end + 接触あり(θ_z=ねじり) | 0.245 | 22°(ねじり) | 263 | active変化でNR急増 |
| 7本 + MPC + 接触なし(θ_z=ねじり) | 0.518 | 47°(ねじり) | 507 | ||R_t||=0.97停滞→2サイクル検知 |
