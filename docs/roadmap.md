...
- [ ] 素線+被膜 等価剛性ベンチマーク（曲げ/ねじり/引張/圧縮/大変形）
- [ ] 素線+シース 等価剛性ベンチマーク（同上）
...
- [ ] **素線+被膜 等価剛性BM**（曲げ/ねじり/引張/圧縮/大変形、NCPソルバー基準、status-098方針）
- [ ] **素線+シース 等価剛性BM**（同上）
- [ ] 素線+被膜+シース フルモデル剛性BM
