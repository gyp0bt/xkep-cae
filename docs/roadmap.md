...
**~2260テスト + 284 新パッケージテスト** | 脱出ポット計画 Phase 8 完了 — friction/geometry 実装完成 + C14 抜け道修正 | [最新status](status/status-index.md)
...
- **脱出ポット計画 Phase 9（未実施）**: solver 内部 Process 化 + NewtonUzawa 分離
