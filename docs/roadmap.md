...
| **3D固体要素** | **HEX8 B-bar（8節点6面体, B-bar法体積ロッキング回避, 3DOF/node, 24DOF/elem）** |
...
- 3次元連続体要素は HEX8 B-bar のみ実装（シースバリデーション用、アセンブリ未統合）
