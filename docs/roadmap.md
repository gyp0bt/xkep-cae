...
- [x] 19/37/61/91本収束レポートテスト（現状未収束 → ブロックソルバー改良が必要, status-097）
- [ ] 19本撚り（3層）接触NR収束達成 — ブロックソルバー根本改良
- [ ] 37本撚り（4層）接触NR収束達成
- [ ] 61/91本撚り接触NR収束達成
...
- [x] HEX8 連続体 vs 素線被膜シース 剛性比較ベンチマーク（梁モデルが適切と結論、status-097）
