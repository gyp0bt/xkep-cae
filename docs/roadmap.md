...
- 梁–梁接触モジュールは C0〜C5（データ構造+幾何+broadphase+Active-set+法線AL+接触接線+NRソルバー+摩擦return mapping+μランプ+merit line search+幾何剛性+slip consistent tangent+PDAS+平行輸送+適応的ペナルティ増強）まで
