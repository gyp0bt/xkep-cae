...
| **3D固体要素** | **HEX8 要素ファミリ — C3D8（SRI+アワーグラス制御: 偏差=1点+体積=2×2×2）、C3D8B（B-bar平均膨張法: Hughes 1980、体積ロッキング回避）、C3D8R（低減積分+Flanagan-Belytschkoアワーグラス制御）、C3D8I（Wilson-Taylor非適合モード+静的縮合）。アセンブリ統合済み。Abaqus準拠命名。** |
