...
- [ ] 7本撚りブロック分解ソルバー（contact_tangent_modeインフラ実装済み。structural_only/diagonal/scaledは収束不可。根本解決にはAL乗数改善 or 反復ソルバー+前処理 or 接触ペア間引きが必要。詳細: status-064）
