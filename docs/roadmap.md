...
**目的**: 撚線モデル（Phase 4.6）の前提となる梁–梁接触を実装する。
...
Phase 3 (幾何学的非線形) ✓
    ↓
    ├── Phase 4 (材料非線形: 4.1〜4.5)
    ├── Phase 5 (動的解析: 時間積分追加)
    └── Phase C (梁–梁接触) ← Phase 3完了後に着手可
            ↓
        Phase 4.6 (撚線モデル) ← Phase C + Cosserat rod + 非線形基盤
            ↓
...
**クリティカルパス**: Phase 3 → Phase C → Phase 4.6

**並行開発可能**:
- Phase 4（4.1〜4.5）と Phase 5 は Phase 3 完了後に並行可
