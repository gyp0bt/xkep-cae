...
def _friction_return_mapping_loop(
    ...
    """
    from xkep_cae_deprecated.contact.assembly import assemble_friction_force
...
class CoulombReturnMappingProcess(SolverProcess[FrictionInput, FrictionOutput]):
    ...
    def tangent(
        ...
        """摩擦接線剛性行列を構築."""
        from xkep_cae_deprecated.contact.assembly import assemble_friction_tangent_stiffness
