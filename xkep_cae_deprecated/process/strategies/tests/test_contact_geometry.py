...
from xkep_cae_deprecated.contact.pair import ContactPair, ContactStatus
...
from xkep_cae_deprecated.process.strategies.protocols import ContactGeometryStrategy
