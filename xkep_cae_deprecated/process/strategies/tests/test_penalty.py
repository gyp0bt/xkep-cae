...
from xkep_cae_deprecated.process.categories import CompatibilityProcess, SolverProcess
...
from xkep_cae_deprecated.process.strategies.protocols import PenaltyStrategy
