"""ContactFrictionProcess — 統一摩擦接触ソルバー（実体実装）.

solver_smooth_penalty.py を分解し、Process が直接 NR ループを駆動する。
Strategy 5軸 + NewtonUzawaLoop + AdaptiveLoadController で構成。
...
from xkep_cae_deprecated.contact.diagnostics import ConvergenceDiagnostics
from xkep_cae_deprecated.contact.graph import snapshot_contact_graph
from xkep_cae_deprecated.contact.initial_penetration import (
    adjust_initial_positions,
    check_initial_penetration,
)
from xkep_cae_deprecated.contact.utils import deformed_coords
from xkep_cae_deprecated.process.base import ProcessMeta
from xkep_cae_deprecated.process.categories import SolverProcess
from xkep_cae_deprecated.process.data import (
    ContactFrictionInputData,
    SolverResultData,
    SolverStrategies,
    default_strategies,
)
from xkep_cae_deprecated.process.slots import StrategySlot, collect_strategy_types
from xkep_cae_deprecated.process.strategies.adaptive_stepping import (
    AdaptiveLoadController,
    AdaptiveSteppingConfig,
)
from xkep_cae_deprecated.process.strategies.newton_uzawa import (
    NewtonUzawaConfig,
    NewtonUzawaLoop,
)
from xkep_cae_deprecated.process.strategies.protocols import (
...
from xkep_cae_deprecated.process.strategies.solver_state import SolverState
...
class ContactFrictionProcess(SolverProcess[ContactFrictionInputData, SolverResultData]):
    ...
    def process(self, input_data: ContactFrictionInputData) -> SolverResultData:
        ...
        solver_smooth_penalty.py を直接置換する実体実装。
        """
