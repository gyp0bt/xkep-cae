...
from xkep_cae_deprecated.math.quaternion import (
    quat_from_rotvec,
    quat_identity,
...
if TYPE_CHECKING:
    from xkep_cae_deprecated.core.constitutive import ConstitutiveProtocol
    from xkep_cae_deprecated.core.results import (
        AssemblyResult,
        FiberAssemblyResult,
        PlasticAssemblyResult,
    )
    from xkep_cae_deprecated.core.state import CosseratFiberPlasticState, CosseratPlasticState
    from xkep_cae_deprecated.materials.plasticity_1d import Plasticity1D
    from xkep_cae_deprecated.sections.beam import BeamSection
    from xkep_cae_deprecated.sections.fiber import FiberSection
...
def assemble_cosserat_beam(
    ...
    *,
    ...
    from xkep_cae_deprecated.core.results import AssemblyResult
...
def assemble_cosserat_beam_plastic(
    ...
    *,
    ...
    from xkep_cae_deprecated.core.results import PlasticAssemblyResult
...
def _compute_generalized_stress_fiber(
    ...
    from xkep_cae_deprecated.core.state import CosseratFiberPlasticState as _CFPS
...
def assemble_cosserat_beam_fiber(
    ...
    *,
    ...
    from xkep_cae_deprecated.core.results import FiberAssemblyResult
