...
if TYPE_CHECKING:
    from xkep_cae_deprecated.contact.pair import ContactConfig, ContactManager
    from xkep_cae_deprecated.mesh.twisted_wire import CoatingModel, SheathModel, TwistedWireMesh
...
def build_sheath_contact_manager(
    ...
    *,
    ...
    """
    from xkep_cae_deprecated.mesh.twisted_wire import (
...
def rebuild_compliance_matrix(
    ...
    *,
    ...
    """
    from xkep_cae_deprecated.mesh.ring_compliance import build_variable_thickness_compliance_matrix
...
def sheath_outer_radius(
    ...
    *,
    ...
    Returns:
        シース外径 [m]
    """
    from xkep_cae_deprecated.mesh.twisted_wire import sheath_inner_radius
...
def build_sheath_sheath_contact_manager(
    ...
    *,
    ...
    from xkep_cae_deprecated.contact.pair import ContactStatus
