...
from xkep_cae_deprecated.thermal.dataset import (
    ThermalProblemConfig,
    place_heat_sources,
    sample_to_graph_data,
)
from xkep_cae_deprecated.thermal.fem import (
    assemble_thermal_system,
    make_irregular_rect_mesh,
    make_rect_mesh,
    solve_steady_thermal,
)
from xkep_cae_deprecated.thermal.gnn import graph_dict_to_pyg
