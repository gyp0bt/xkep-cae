...
from xkep_cae_deprecated.numerical_tests.core import (
    NumericalTestConfig,
    StaticTestResult,
...
def _get_ke_func(cfg: NumericalTestConfig, sec: dict):
    ...
    if cfg.beam_type == "eb2d":
        from xkep_cae_deprecated.elements.beam_eb2d import eb_beam2d_ke_global

        A_sec, I_sec = sec["A"], sec["I"]
        return lambda coords: eb_beam2d_ke_global(coords, E, A_sec, I_sec)

    elif cfg.beam_type == "timo2d":
        from xkep_cae_deprecated.elements.beam_timo2d import timo_beam2d_ke_global
        ...
        from xkep_cae_deprecated.elements.beam_timo3d import timo_beam3d_ke_global
        ...
        from xkep_cae_deprecated.elements.beam_cosserat import cosserat_ke_global
...
def _compute_section_forces(
    ...
    if cfg.beam_type == "eb2d":
        from xkep_cae_deprecated.elements.beam_eb2d import eb_beam2d_section_forces
        ...
        from xkep_cae_deprecated.elements.beam_timo2d import timo_beam2d_section_forces
        ...
        from xkep_cae_deprecated.elements.beam_cosserat import cosserat_section_forces
