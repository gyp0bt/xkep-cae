...
from xkep_cae_deprecated.dynamics import NonlinearTransientConfig, solve_nonlinear_transient
...
from xkep_cae_deprecated.numerical_tests.frequency import (
    _assemble_lumped_mass_2d,
    _assemble_lumped_mass_3d,
    _assemble_mass_2d,
    _assemble_mass_3d,
)
from xkep_cae_deprecated.numerical_tests.runner import (
    _assemble_2d,
    _assemble_3d,
...
def _make_cr_beam_assemblers(
    ...
    Returns:
        (assemble_internal_force, assemble_tangent) タプル
    """
    from xkep_cae_deprecated.elements.beam_timo3d import assemble_cr_beam3d
...
def _make_cosserat_nl_beam_assemblers(
    ...
    Returns:
        (assemble_internal_force, assemble_tangent) タプル
    """
    from xkep_cae_deprecated.elements.beam_cosserat import assemble_cosserat_nonlinear
