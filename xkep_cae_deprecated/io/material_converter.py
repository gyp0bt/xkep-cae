...
from xkep_cae_deprecated.materials.plasticity_1d import (
    IsotropicHardening,
    KinematicHardening,
    Plasticity1D,
...
if TYPE_CHECKING:
    from xkep_cae_deprecated.io.abaqus_inp import AbaqusMaterial
    from xkep_cae_deprecated.materials.plasticity_3d import PlaneStrainPlasticity
...
def abaqus_material_to_plane_strain_plasticity(
    ...
    """
    from xkep_cae_deprecated.materials.plasticity_3d import (
