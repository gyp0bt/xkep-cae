...
def run_bending_oscillation(
    ...
    *,
    ...
    from xkep_cae.contact.initial_penetration import check_initial_penetration as _check_ip

    n_initial_pen = _check_ip(mgr.pairs, mesh.node_coords, mgr.config.coating_stiffness)
